 ...
 * (see http://www.github.com/analogdevicesinc/).
 *
...
//    d_availableTools = QStringList() << tr("Signal Generator") << tr("Power Supply")
//                                        << tr("Debugger")
//                                     << tr("Calibration");

//    d_availableIcons = QStringList() << "signal_generator" << "power_supply"<< "debugger"
//                                     << "calibration";
	_loadState();
